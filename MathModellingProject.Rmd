...
![figure 1](./PhiRes_mikasa1_onechannell_resize2/Phi_Mar1_C1_182_C2_43_Iter10000_deltT_1e-1.png)

再来一张：

```{r, out.width = "100%", fig.cap = "figure 2"}
knitr::include_graphics("./PhiRes_mikasa1_onechannell_resize2/Phi_Mar10_C1_204_C2_50_Iter10000_deltT_1e-1.png")
```
